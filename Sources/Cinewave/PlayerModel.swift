...
final class PlayerModel {
    ...
    private static let queueDefaultsKey = "player.queue.v1"
    ...
    init() {
        ...
        if let storedQueue = Self.load(QueuePersistence.self, key: Self.queueDefaultsKey) {
    ...
    private static func isRestorableQueueItem(_ item: MediaItem) -> Bool {
